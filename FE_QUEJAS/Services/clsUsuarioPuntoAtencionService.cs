...
namespace FE_QUEJAS.Services
{
    public class clsUsuarioPuntoAtencionService
    {
        public async Task<List<Regiones>> obtenerRegionesApi(string token)
        {
            ...
            HttpResponseMessage respuesta = await httpClient.GetAsync("http://20.92.250.90/API_Quejas/API/USUARIOPUNTOATENCION/ObtenerRegiones");
        ...
        public async Task<List<Cargos>> obtenerCargosApi(string token)
        {
            ...
            httpClient.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
            HttpResponseMessage respuesta = await httpClient.GetAsync("http://20.92.250.90/API_Quejas/API/USUARIOPUNTOATENCION/ObtenerCargos");
            string respuestaJson = await respuesta.Content.ReadAsStringAsync();
        ...
        public async Task<List<PuntoAtencion>> obtenerPuntosApi(string token)
        {
            ...
            HttpResponseMessage respuesta = await httpClient.PostAsync("http://20.92.250.90/API_Quejas/API/USUARIOPUNTOATENCION/ObtenerPuntos", new StringContent(json, System.Text.Encoding.UTF8, "application/json"));
            string respuestaJson = await respuesta.Content.ReadAsStringAsync();
        ...
        public async Task<List<UsuarioPuntoAtencion>> obtenerusuariosApi(string token)
        {
            ...
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
            string json = JsonConvert.SerializeObject("");
            HttpResponseMessage respuesta = await httpClient.PostAsync("http://20.92.250.90/API_Quejas/API/USUARIOPUNTOATENCION/ObtenerUsuarios", new StringContent(json, System.Text.Encoding.UTF8, "application/json"));
            string respuestaJson = await respuesta.Content.ReadAsStringAsync();
            var resultado = JsonConvert.DeserializeObject(respuestaJson);
            if (respuesta.StatusCode == HttpStatusCode.Found)
        ...
        public async Task<bool> actualizarDatosUsuario(UsuarioPuntoAtencion usuario, string token)
        {
            ...
            HttpResponseMessage respuesta = await httpClient.PostAsync("http://20.92.250.90/API_Quejas/API/USUARIOPUNTOATENCION/ActualizarDatosUsuario", new StringContent(json, System.Text.Encoding.UTF8, "application/json"));
            string respuestaJson = await respuesta.Content.ReadAsStringAsync();
            var resultado = JsonConvert.DeserializeObject(respuestaJson);
        ...
        public async Task<List<UsuarioPuntoAtencion>> obtenerUsuarioPorCui(string token, UsuarioPuntoAtencion usuario)
        {
            ...
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
            string json = JsonConvert.SerializeObject(usuario);
            HttpResponseMessage respuesta = await httpClient.PostAsync("http://20.92.250.90/API_Quejas/API/USUARIOPUNTOATENCION/ObtieneDatosUsuarioPorCui", new StringContent(json, System.Text.Encoding.UTF8, "application/json"));
            string respuestaJson = await respuesta.Content.ReadAsStringAsync();
            var resultado = JsonConvert.DeserializeObject(respuestaJson);
            if (respuesta.StatusCode == HttpStatusCode.Found)
                objetoRespuesta = JsonConvert.DeserializeObject<List<UsuarioPuntoAtencion>>(respuestaJson);
