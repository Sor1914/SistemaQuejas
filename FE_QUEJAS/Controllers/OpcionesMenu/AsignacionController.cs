...
namespace FE_QUEJAS.Controllers.OpcionesMenu
{
    public class AsignacionController : Controller
    {
        ...
        public async Task<ActionResult> Asignacion(bool limpiar = true)
        {
            if (limpiar)
            {
        ...
        public async Task<ActionResult> Paginacion(int pagina = 1, int tamanoPagina = 5)
        {
            ...
            {
                ListaQuejas = await _Asignacion.obtenerQuejasAsignacion(token);
            ...
            return PartialView("_TablaQuejasAsignadas");
        }
        ...
        public async Task<ActionResult> guardarRechazoQueja(EncabezadoQueja encabezado, int idEncabezado)
        {
            try
            {
                ...
                {
                    string html = crearHtmlRechazoCliente(encabezado.Justificacion);
